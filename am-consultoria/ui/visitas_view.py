...
class VisitasView(ttk.Frame):
    ...
    def atualizar_tabela(self):
        ...
        for v in listar_visitas():
            self.tree.insert("", "end", values=(v['id'], v['cliente_nome'], v['data_visita'], v['tipo_visita'], v['prioridade']))
    ...
    def abrir_pendencia_rapida(self, cliente_id, visita_id):
        ...
        ttk.Label(frame, text="Prazo (AAAA-MM-DD)").pack(anchor="w")
        ...
        def salvar_p():
            if not desc.get():
                ...
                return
            criar_pendencia(cliente_id, visita_id, desc.get(), prazo.get(), prio.get())
